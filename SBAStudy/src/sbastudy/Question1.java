...
//		for(int i=0; i<array.length;i++) {
//			
//			String addedString=array[i];
//			
//			list.add(addedString);
//			
//			System.out.println("I have added "+ addedString+" at position "+ i );
//		}
//		
//		
...
//		    String replaced = list.get(pos);
//		    list.set(pos,"");
//		    System.out.println(" replaced the string: " + replaced+ " with a null string");
//		}
//		
//		
//	}	
