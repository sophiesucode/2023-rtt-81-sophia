...
//unspecified number of integers. The input 0 signifies the end 
//of the input.If data is not 0, it is added to the sum, and the 
//next input data are read. If data is 0, the loop body is not 
//executed, and the while loop terminates. 
